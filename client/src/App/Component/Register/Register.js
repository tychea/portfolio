    ...
    <div className='formWrapper'>
      <form className='form' onSubmit={handleSubmit(formSubmit)}>
        ...
        <div className='formItemWrapper'>
          <div className={errors.name ? 'formItem formWarning' : 'formItem'}>
            <i
              className={errors.name ? 'fas fa-user warning' : 'fas fa-user'}
            ></i>
            <input
              ref={register({
...
export default withRouter(RedirectAuth(Register));
